 ...
 *
 * Usage:
 *   npx tsx scripts/test-illustration-cli.ts --page 1 --style watercolor --character ./test-character.png
 *   npx tsx scripts/test-illustration-cli.ts --style watercolor --character ./test-character.png --character ./test-character-2.png --scene "두 아이가 공원에서 공을 주고받으며 신나게 놀고 있다"
 */
...
function printUsage(): never {
  console.error(`Usage:
  npx tsx scripts/test-illustration-cli.ts --page <n> --style <artStyleKey> --character <localImagePath> [--out <pngPath>] [--template <title>] [--api responses|images] [--quality low|medium|high]
  npx tsx scripts/test-illustration-cli.ts --style <artStyleKey> --character <path> --character <path> [--character <path>] --scene "<scene text>" [--quality low|medium|high]

Example:
  npx tsx scripts/test-illustration-cli.ts --page 1 --style watercolor --character ./test-character.png
  npx tsx scripts/test-illustration-cli.ts --style watercolor --character ./test-character.png --character ./test-character-2.png --scene "두 아이가 공원 잔디밭에서 손을 잡고 함께 뛰어놀고 있다"
  npx tsx scripts/test-illustration-cli.ts --page 1 --style watercolor --character ./test-character.png --quality low
  npx tsx scripts/test-illustration-cli.ts --page 1 --style watercolor --character ./test-character.png --api images
`);
  process.exit(1);
}
